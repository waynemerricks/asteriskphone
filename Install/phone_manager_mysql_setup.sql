...
INSERT INTO `clientsettings` VALUES 
	...
	(4,'GLOBAL','callLocal','Birmingham, United Kingdom'), -- Default location to use if a call is local < 8 digits
	(5,'GLOBAL','callNational','United Kingdom'), -- Default location to use if a call is national < 12 digits
	(6,'GLOBAL','XMPPRoom','phonebox@conference.elastix'), -- Main XMPP Chat Room, usually room_name@conference.xmpp_domain 
	(7,'GLOBAL','XMPPControlRoom','phoneboxcontrol@conference.elastix'), -- Control XMPP Chat for sending transfer etc commands 	
	(8,'GLOBAL','XMPPDomain','elastix'), -- Default XMPP Domain 
	(9,'GLOBAL','idleTimeout','120000'), -- Milliseconds before people are marked as away in XMPP Chat (2 Minutes) 
	(10,'GLOBAL','writeDBHost','10.43.5.50'), -- Host IP/Name where a client can write to a Database
	(11,'GLOBAL','writeDBUser','phonemanager'), -- User with write privileges
	(12,'GLOBAL','writeDBPass','Ph0n3m4n4g3r'), -- Password for write privileges 
	(13,'GLOBAL','writeDBDatabase','TVAPhoneManager'), -- Database name that you can write to 
	(14,'GLOBAL','incomingQueueNumber','3000'), -- Asterisk Queue to use for incoming calls 
	(15,'GLOBAL','onAirQueueNumber','3001'), -- Asterisk Queue to use to mark calls ready for on air use 
	(16,'GLOBAL','studioExtensions','5005=>Studio 1,5006=>Studio 2'), -- mapped csv list of any extensions that are studios 
	(17,'GLOBAL','queue_3001_icon','images/cross.png'), /* queue_xxxx_icon will set a default call icon on that queue to the given 
							       image */
	(18,'GLOBAL','threadPoolMax','4'), -- When doing things like DB writes how many threads we can spin up as a max 

/* Change serverHostName to the host name where the server component is running */

	(19,'serverHostName','asteriskHost','10.43.10.91'), -- IP/Host name of the Asterisk Server 
	(20,'serverHostName','asteriskUser','change me to a user name'), -- User name to use to access the Asterisk Manager Interface 
	(21,'serverHostName','asteriskPass','change me to a password'), -- Password to use to access the Asterisk Manager Interface 
	(22,'serverHostName','autoAnswerContext','custom-answerme'), -- Asterisk context to use that adds the Auto Answer headers 
	(23,'serverHostName','defaultContext','from-internal'), -- Default Asterisk context 
	(24,'serverHostName','contextMacroAuto','macro-auto-blkvm'), /* Used to ignore a lot of events generated by Asterisk with this 
									context */
	(25,'serverHostName','defaultTimeOut','30000'), -- Time out in milliseconds before assuming Asterisk command failed 
	(26,'serverHostName','channelLockTimeOut','3000'), /* Time out in milliseconds to ignore further commands sent on a channel, this 
...
/* Change sampleClientHostName to the host name where a client is running */
	...
	(27,'sampleClientHostName','myExtension','5001'), -- Asterisk Extension that this client will use 
	(28,'sampleClientHostName','isStudio','false'), /* Prevents studio chat shortcuts and also won't mark the call red to other 
							   clients, change to true if this is a studio */
	(29,'sampleClientHostName','timezoneHourOffset','30'); /* [Optional] if you are in a timezone that is weird with +/- parts of an 
